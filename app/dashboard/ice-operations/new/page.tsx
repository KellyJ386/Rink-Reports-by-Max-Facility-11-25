...
export default async function NewIceOperationsPage() {
  ...
  // Get the active Ice Operations form template
    ...
    return (
      <div className="card p-12 text-center">
        ...
        <p className="text-gray-600 mt-2">
          An Ice Operations form template needs to be created before you can submit reports.
