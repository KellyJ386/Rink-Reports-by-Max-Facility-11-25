...
export default function IceDepthPage() {
    ...
    async function fetchData() {
      try {
        const [rinksRes, templatesRes, submissionsRes] = await Promise.all([
          fetch('/api/rinks'),
          fetch('/api/form-templates?moduleType=ICE_DEPTH&isActive=true'),
          fetch('/api/submissions?moduleType=ICE_DEPTH&limit=5'),
        ])
  ...
  const handleSubmit = async (values: Record<string, any>) => {
    ...
    try {
      ...
      setSuccess('Ice depth report submitted successfully!')
      setFormValues({})
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ice Depth Report</h1>
            <p className="text-gray-500">Record ice thickness measurements</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        {template ? (
          ...
          <div className="text-center py-12 text-gray-500">
            <p className="mb-4">No ice depth form template has been configured.</p>
            <Link
      ...
      {recentSubmissions.length > 0 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <Link
            href="/dashboard/submissions?moduleType=ICE_DEPTH"
